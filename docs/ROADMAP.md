...
| [Phase 2](./implementation/phase-2-frontend-shell.md) | 前端骨架 + 连接 + Sidebar | 3-4 天 |
...
| 版本 | 实施文档 |
|------|----------|
| v0.2 | [phase-v0.2-enhancements.md](./implementation/phase-v0.2-enhancements.md) |
| v0.3 | [phase-v0.3-exploration.md](./implementation/phase-v0.3-exploration.md) |
| v1.0 | [phase-v1.0-multi-connection.md](./implementation/phase-v1.0-multi-connection.md) |
| v1.x | [phase-v1.x-multi-database.md](./implementation/phase-v1.x-multi-database.md) |
